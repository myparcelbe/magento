...
class CreateAndPrintMyParcelTrack extends \Magento\Framework\App\Action\Action
{
    ...
    private function massAction()
    {
        ...
        try {
            ...
            if (count($this->messageManager->getMessages()) == 0) {
                $this->messageManager->addErrorMessage(__('An error has occurred while creating a MyParcel label. To get your personal API credentials you should contact MyParcel.'));
                $this->_objectManager->get('Psr\Log\LoggerInterface')->critical($e);
            }
        }
