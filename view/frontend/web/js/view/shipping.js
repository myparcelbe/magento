...
define([
  ...
  'MyParcelBE_Magento/js/delivery-options',
], function(
  $,
  _,
  Component,
  ...
  return Component.extend({
    ...
    validateShippingInformation: function() {
      ...
      var field;
      var country = registry.get(this.parentName + '.shippingAddress.shipping-address-fieldset.country_id');
      var countryIndexedOptions = country.indexedOptions;
      var option = countryIndexedOptions[quote.shippingAddress().countryId];
